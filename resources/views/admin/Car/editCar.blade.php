            ...
            <div class="col-md-12 col-xl-12 middle-wrapper">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{route('update.car',$car->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="daily_rent_price" class="form-control" value="{{$car->daily_rent_price}}">
                                        </div>
                                        <!-- Col -->
                                    </div>
                                    <div class="col-sm-6">
